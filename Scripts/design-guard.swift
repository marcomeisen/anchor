...
let rules = [
    Rule(label: "cornerRadius", pattern: "cornerRadius",
         reason: "Radius ist im ganzen System 0. Rectangle() benutzen."),
    Rule(label: "Capsule", pattern: #"Capsule\("#,
         reason: "Eine Kapsel ist ein Radius. Rectangle() oder AnkerProgressBar benutzen."),
    ...
    Rule(label: "Weiss/Schwarz", pattern: #"Color\.(?:white|black)|\.(?:white|black)\.opacity"#,
         reason: "AnkerColor.onAccent bzw. eine Rampenstufe benutzen."),
